...
class ConvKernelHead(nn.Module):
    ...
    def __init__(self,
        ...
        self.sampling = False
        self.localization_fpn = MODELS.build(localization_fpn)
    ...
    def forward_train(self,
        ...
        for i in range(num_imgs):
            pred_instances = InstanceData(masks=scaled_mask_preds[i].detach())
                                        #   scores=detached_cls_scores[i])
            gt_instances = InstanceData(masks=gt_masks[i],
                                        labels=gt_labels[i])
    ...
    def get_targets(self,
        ...
        pos_gt_labels_list = [gt_labels[i][res.pos_assigned_gt_inds] for i, res in enumerate(sampling_results)]
